...
public class ParticlesModel {
  ...
  /**
   * Returns an iterable object containing all possible collisions that p would undergo starting
   * 'now' if it continued along its current trajectory.
   */
  ...
  /**
   * Returns an iterable object containing all possible collisions that all particles would undergo
   * starting 'now' if they all continued along their current trajectories.
   */
